...
def winner_check():
    global winner
    if (
        available_positions[0] is not True
        and available_positions[0] == available_positions[1] == available_positions[2]
    ):
        winner = available_positions[0]
    elif (
        available_positions[0] is not True
        and available_positions[0] == available_positions[3] == available_positions[6]
    ):
        winner = available_positions[0]
    elif (
        available_positions[0] is not True
        and available_positions[0] == available_positions[4] == available_positions[8]
    ):
        winner = available_positions[0]
    elif (
        available_positions[1] is not True
        and available_positions[1] == available_positions[4] == available_positions[7]
    ):
        winner = available_positions[1]
    elif (
        available_positions[2] is not True
        and available_positions[2] == available_positions[5] == available_positions[8]
    ):
        winner = available_positions[2]
    elif (
        available_positions[2] is not True
        and available_positions[2] == available_positions[4] == available_positions[6]
    ):
        winner = available_positions[2]
    elif (
        available_positions[3] is not True
        and available_positions[3] == available_positions[4] == available_positions[5]
    ):
        winner = available_positions[3]
    elif (
        available_positions[6] is not True
        and available_positions[6] == available_positions[7] == available_positions[8]
    ):
...
def placement_user(self):
    ...
    if button_pressed not in ["O", "X"]:
        ...
        if turns_remaining > 0 and winner is None:
...
def placement_comp():
    ...
    if available_positions[comps_pos] is not True:
        placement_comp()
